...
def number_of_robots_sensors(robot):
    print(robot.sensors_amount())
...
number_of_robots_sensors(basic_robot)
number_of_robots_sensors(da_vinci)
number_of_robots_sensors(moley)
number_of_robots_sensors(griffin)
