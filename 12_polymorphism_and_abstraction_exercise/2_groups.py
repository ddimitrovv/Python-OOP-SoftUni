...
# Create another class called Group. Upon initialization, it should receive a name (str)
# and people (list of Person instances). Implement the needed magic methods so that:
...
class Group:
    ...
    def __add__(self, other):
        ...
        total_people = self.people + other.people
        return Group(name, total_people)
