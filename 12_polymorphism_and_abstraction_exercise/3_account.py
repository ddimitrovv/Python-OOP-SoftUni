# Create a single class called Account. Upon initialization, it should receive an owner (str)
# and a starting amount (int, optional, 0 by default).
...
#         ◦ If the balance becomes less than zero, raise ValueError with the message "sorry cannot go in debt!"
...
class Account:
    ...
    def __add__(self, other):
        ...
        [new_account.add_transaction(t) for t in self._transactions]
